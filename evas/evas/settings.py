"""
Django settings for evas project.
...
SECRET_KEY = 'django-insecure-g9ci+jan5*7+=b7!dh^1k98+1_7u#k+uf!(7ype7i@d1*hi=n#'
...
WSGI_APPLICATION = 'evas.wsgi.application'
